  ...
  extends LinearLayout
{
  ...
  public ButtonBarLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      a = paramContext.getBoolean(a.j.ButtonBarLayout_allowStacking, bool);
    ...
    if ((!a()) && (View.MeasureSpec.getMode(paramInt1) == 1073741824))
    {
      ...
      if (a)
      {
        ...
        if (!a())
        {
          ...
          if ((w.i(this) & 0xFF000000) != 16777216) {
            break label275;
          }
          i = 1;
          label117:
      ...
      j = topMargin;
      paramInt2 = bottomMargin + (i + paramInt2 + j) + 0;
      if (!a()) {
        break label344;
      }
      i = a(paramInt1 + 1);
      paramInt1 = paramInt2;
      if (i >= 0) {
        paramInt1 = (int)(paramInt2 + (getChildAt(i).getPaddingTop() + 16.0F * getResourcesgetDisplayMetricsdensity));
      }
    }
    for (;;)
    {
      if (w.r(this) != paramInt1) {
