  ...
  implements h.b, p
{
  ...
  private c b(AttributeSet paramAttributeSet)
  {
  ...
  public Menu getMenu()
  {
    ...
    if (a == null)
    {
      ...
      a = new h((Context)localObject);
      a.a(new d());
      c = new d((Context)localObject);
      c.e();
      locald = c;
      if (h == null) {
        break label108;
    ...
    label108:
    for (Object localObject = h;; localObject = new b())
    {
      f = ((o.a)localObject);
      a.a(c, f);
      c.a(this);
    ...
    implements h.a
  {
    ...
    {
      return (e != null) && (e.a(paramMenuItem));
    }
  }
