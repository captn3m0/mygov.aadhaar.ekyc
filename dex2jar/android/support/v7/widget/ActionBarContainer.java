  ...
  extends FrameLayout
{
  ...
  public ActionBarContainer(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      a = paramContext.getDrawable(a.j.ActionBar_background);
      b = paramContext.getDrawable(a.j.ActionBar_backgroundStacked);
      j = paramContext.getDimensionPixelSize(a.j.ActionBar_height, -1);
      if (getId() == a.f.split_action_bar)
      {
        d = true;
        c = paramContext.getDrawable(a.j.ActionBar_backgroundSplit);
      }
  ...
  public void setTabContainer(ay paramay)
  {
    ...
    {
      addView(paramay);
      ViewGroup.LayoutParams localLayoutParams = paramay.getLayoutParams();
      width = -1;
      height = -2;
