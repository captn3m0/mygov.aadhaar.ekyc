...
public final class p
{
  ...
  {
    if ((a) && (c != null)) {
      return ac.a(c, b, paramFloat1, paramFloat2);
    }
    return false;
  }
  ...
  {
    if ((a) && (c != null)) {
      return ac.a(c, b, paramFloat1, paramFloat2, paramBoolean);
    }
    return false;
  }
  ...
  public final boolean a(int paramInt)
  {
    ...
    if (a)
    {
      ...
      {
        if (ac.a(localViewParent, localView, b, paramInt))
        {
          c = localViewParent;
          ac.b(localViewParent, localView, b, paramInt);
          return true;
        }
  ...
  public final boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfInt)
  {
    ...
    for (;;)
    {
      ac.a(c, b, paramInt1, paramInt2, paramInt3, paramInt4);
      if (paramArrayOfInt != null)
      {
        b.getLocationInWindow(paramArrayOfInt);
        paramArrayOfInt[0] -= j;
  ...
  public final boolean a(int paramInt1, int paramInt2, int[] paramArrayOfInt1, int[] paramArrayOfInt2)
  {
    ...
    for (;;)
    {
      ...
      arrayOfInt[0] = 0;
      arrayOfInt[1] = 0;
      ac.a(c, b, paramInt1, paramInt2, arrayOfInt);
      if (paramArrayOfInt2 != null)
      {
        b.getLocationInWindow(paramArrayOfInt2);
