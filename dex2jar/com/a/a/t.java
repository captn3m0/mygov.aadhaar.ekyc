...
public class t
{
  ...
  private static String e(String paramString, Object... paramVarArgs)
  {
    ...
    if (paramVarArgs == null)
    {
      ...
      str = String.valueOf(String.valueOf(str.substring(str.lastIndexOf('$') + 1)));
      paramVarArgs = String.valueOf(String.valueOf(paramVarArgs[i].getMethodName()));
    }
    label172:
    label179:
    for (paramVarArgs = str.length() + 1 + paramVarArgs.length() + str + "." + paramVarArgs;; paramVarArgs = "<unknown>")
    {
  ...
  static final class a
  {
    ...
    public final void a(String paramString)
    {
      ...
      //   2: aload_0
      //   3: iconst_1
      //   4: putfield 31	com/a/a/t$a:c	Z
      //   7: aload_0
      //   8: getfield 29	com/a/a/t$a:b	Ljava/util/List;
      ...
      //   31: return
      //   32: aload_0
      //   33: getfield 29	com/a/a/t$a:b	Ljava/util/List;
      //   36: iconst_0
      //   37: invokeinterface 42 2 0
      //   42: checkcast 9	com/a/a/t$a$a
      //   45: getfield 45	com/a/a/t$a$a:c	J
      //   48: lstore_3
      //   49: aload_0
      //   50: getfield 29	com/a/a/t$a:b	Ljava/util/List;
      //   53: aload_0
      //   54: getfield 29	com/a/a/t$a:b	Ljava/util/List;
      //   57: invokeinterface 38 1 0
      //   62: iconst_1
      //   63: isub
      //   64: invokeinterface 42 2 0
      //   69: checkcast 9	com/a/a/t$a$a
      //   72: getfield 45	com/a/a/t$a$a:c	J
      //   75: lload_3
      //   76: lsub
      //   77: lstore_3
      //   78: goto -55 -> 23
      //   81: aload_0
      //   82: getfield 29	com/a/a/t$a:b	Ljava/util/List;
      //   85: iconst_0
      //   86: invokeinterface 42 2 0
      //   91: checkcast 9	com/a/a/t$a$a
      //   94: getfield 45	com/a/a/t$a$a:c	J
      //   97: lstore 5
      //   99: ldc 47
      //   101: iconst_2
      ...
      //   114: aload_1
      //   115: aastore
      //   116: invokestatic 56	com/a/a/t:b	(Ljava/lang/String;[Ljava/lang/Object;)V
      //   119: aload_0
      //   120: getfield 29	com/a/a/t$a:b	Ljava/util/List;
      ...
      //   147: checkcast 9	com/a/a/t$a$a
      //   150: astore 7
      //   152: aload 7
      //   154: getfield 45	com/a/a/t$a$a:c	J
      //   157: lstore 5
      //   159: ldc 72
      //   161: iconst_3
      ...
      //   176: iconst_1
      //   177: aload 7
      //   179: getfield 74	com/a/a/t$a$a:b	J
      //   182: invokestatic 53	java/lang/Long:valueOf	(J)Ljava/lang/Long;
      //   185: aastore
      //   186: dup
      //   187: iconst_2
      //   188: aload 7
      //   190: getfield 77	com/a/a/t$a$a:a	Ljava/lang/String;
      //   193: aastore
      //   194: invokestatic 56	com/a/a/t:b	(Ljava/lang/String;[Ljava/lang/Object;)V
      //   197: lload 5
      //   199: lstore_3
      //   200: goto -68 -> 132
      //   203: astore_1
