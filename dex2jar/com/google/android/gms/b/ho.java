...
public final class ho
{
  ...
  {
    long l = (hm.a(paramArrayOfString[0]) + 2147483647L) % 1073807359L;
    int i = 1;
    while (i < paramInt + 0)
    {
      l = (l * 16785407L % 1073807359L + (hm.a(paramArrayOfString[i]) + 2147483647L) % 1073807359L) % 1073807359L;
      i += 1;
    }
    return l;
  }
  ...
  private static void a(int paramInt1, long paramLong, String paramString, int paramInt2, PriorityQueue<a> paramPriorityQueue)
  {
    paramString = new a(paramLong, paramString, paramInt2);
    if ((paramPriorityQueue.size() == paramInt1) && ((peekc > c) || (peeka > a))) {}
    do
    {
      do
      {
  ...
  public static void a(String[] paramArrayOfString, int paramInt1, int paramInt2, PriorityQueue<a> paramPriorityQueue)
  {
    ...
    for (;;)
    {
      ...
      {
        int j = hm.a(paramArrayOfString[(i - 1)]);
        int k = hm.a(paramArrayOfString[(i + paramInt2 - 1)]);
