  ...
  implements b
{
  ...
  private void a(String paramString, c.a parama)
  {
    ...
    for (b = l1;; b = l1)
    {
      ...
      return;
      localObject = (c.a)a.get(paramString);
      l2 = b;
      long l3 = a;
      l1 = a;
      l1 = l3 - l1 + l2;
  ...
  private void b(String paramString)
  {
    try
    {
      ...
      if (!bool)
      {
        ...
        arrayOfObject[j] = str;
        t.b((String)localObject1, arrayOfObject);
      }
      return;
    }
    finally {}
  ...
  private static String c(String paramString)
  {
    ...
    String str1 = String.valueOf(String.valueOf(j));
    i = paramString.substring(i).hashCode();
  ...
  public final b.a a(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 29	com/a/a/a/c:a	Ljava/util/Map;
    //   6: astore_2
    //   7: aload_2
    //   8: aload_1
    ...
    //   30: aload_0
    //   31: aload_1
    //   32: invokespecial 128	com/a/a/a/c:d	(Ljava/lang/String;)Ljava/io/File;
    //   35: astore_3
    //   36: new 208	com/a/a/a/c$b
    //   39: astore 4
    //   41: new 210	java/io/BufferedInputStream
    //   44: astore 5
    //   46: new 212	java/io/FileInputStream
    //   49: astore 6
    //   51: aload 6
    //   53: aload_3
    //   54: invokespecial 213	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   57: aload 5
    //   59: aload 6
    //   61: invokespecial 216	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   64: iconst_0
    //   65: istore 7
    //   67: aconst_null
    //   68: astore 6
    ...
    //   72: aload 5
    //   74: iconst_0
    //   75: invokespecial 219	com/a/a/a/c$b:<init>	(Ljava/io/InputStream;B)V
    //   78: aload 4
    //   80: invokestatic 222	com/a/a/a/c$a:a	(Ljava/io/InputStream;)Lcom/a/a/a/c$a;
    //   83: pop
    //   84: aload_3
    //   85: invokevirtual 225	java/io/File:length	()J
    //   88: lstore 8
    //   90: aload 4
    //   92: invokestatic 228	com/a/a/a/c$b:a	(Lcom/a/a/a/c$b;)I
    //   95: i2l
    //   96: lstore 10
    //   98: lload 8
    //   100: lload 10
    ...
    //   110: aload 4
    //   112: iload 12
    //   114: invokestatic 154	com/a/a/a/c:a	(Ljava/io/InputStream;I)[B
    //   117: astore 6
    //   119: new 230	com/a/a/b$a
    //   122: astore 5
    //   124: aload 5
    //   126: invokespecial 231	com/a/a/b$a:<init>	()V
    //   129: aload 5
    //   131: aload 6
    //   133: putfield 234	com/a/a/b$a:a	[B
    //   136: aload_2
    //   137: getfield 237	com/a/a/a/c$a:c	Ljava/lang/String;
    //   140: astore 6
    //   142: aload 5
    //   144: aload 6
    //   146: putfield 239	com/a/a/b$a:b	Ljava/lang/String;
    //   149: aload_2
    //   150: getfield 241	com/a/a/a/c$a:d	J
    //   153: lstore 8
    //   155: aload 5
    //   157: lload 8
    //   159: putfield 243	com/a/a/b$a:c	J
    //   162: aload_2
    //   163: getfield 245	com/a/a/a/c$a:e	J
    //   166: lstore 8
    //   168: aload 5
    //   170: lload 8
    //   172: putfield 246	com/a/a/b$a:d	J
    //   175: aload_2
    //   176: getfield 249	com/a/a/a/c$a:f	J
    //   179: lstore 8
    //   181: aload 5
    //   183: lload 8
    //   185: putfield 250	com/a/a/b$a:e	J
    //   188: aload_2
    //   189: getfield 253	com/a/a/a/c$a:g	J
    //   192: lstore 8
    //   194: aload 5
    //   196: lload 8
    //   198: putfield 254	com/a/a/b$a:f	J
    //   201: aload_2
    //   202: getfield 257	com/a/a/a/c$a:h	Ljava/util/Map;
    //   205: astore_2
    //   206: aload 5
    //   208: aload_2
    //   209: putfield 259	com/a/a/b$a:g	Ljava/util/Map;
    //   212: aload 4
    //   214: invokevirtual 262	com/a/a/a/c$b:close	()V
    //   217: aload 5
    //   219: astore_2
    //   220: goto -194 -> 26
    //   223: astore_2
    ...
    //   249: astore 6
    //   251: aload_3
    //   252: invokevirtual 267	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   255: astore_3
    //   256: aload 6
    //   258: iconst_0
    //   259: aload_3
    ...
    //   262: istore 13
    //   264: aload_2
    //   265: invokevirtual 268	java/io/IOException:toString	()Ljava/lang/String;
    //   268: astore_2
    //   269: aload 6
    //   271: iload 13
    //   273: aload_2
    ...
    //   275: aload 4
    //   277: aload 6
    //   279: invokestatic 148	com/a/a/t:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   282: aload_0
    //   283: aload_1
    //   284: invokespecial 270	com/a/a/a/c:b	(Ljava/lang/String;)V
    //   287: aload 5
    //   289: ifnull +8 -> 297
    //   292: aload 5
    //   294: invokevirtual 262	com/a/a/a/c$b:close	()V
    //   297: aconst_null
    //   298: astore_2
    //   299: goto -273 -> 26
    //   302: astore_2
    ...
    //   314: ifnull +8 -> 322
    //   317: aload 4
    //   319: invokevirtual 262	com/a/a/a/c$b:close	()V
    //   322: aload_2
    //   323: athrow
    //   324: astore_2
    //   325: aload_0
  ...
  public final void a()
  {
    ...
    //   5: monitorenter
    //   6: aload_0
    //   7: getfield 33	com/a/a/a/c:c	Ljava/io/File;
    //   10: astore_3
    //   11: aload_3
    //   12: invokevirtual 273	java/io/File:exists	()Z
    //   15: istore 4
    //   17: iload 4
    //   19: ifne +59 -> 78
    //   22: aload_0
    //   23: getfield 33	com/a/a/a/c:c	Ljava/io/File;
    //   26: astore_2
    //   27: aload_2
    //   28: invokevirtual 276	java/io/File:mkdirs	()Z
    //   31: istore_1
    //   32: iload_1
    //   33: ifne +42 -> 75
    //   36: ldc_w 278
    ...
    //   50: istore 5
    //   52: aload_0
    //   53: getfield 33	com/a/a/a/c:c	Ljava/io/File;
    //   56: astore 6
    //   58: aload 6
    //   60: invokevirtual 267	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   63: astore 6
    //   65: aload_3
    //   66: iconst_0
    //   67: aload 6
    ...
    //   70: aload_2
    //   71: aload_3
    //   72: invokestatic 280	com/a/a/t:c	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   75: aload_0
    //   76: monitorexit
    //   77: return
    //   78: aload_0
    //   79: getfield 33	com/a/a/a/c:c	Ljava/io/File;
    //   82: astore_3
    //   83: aload_3
    //   84: invokevirtual 284	java/io/File:listFiles	()[Ljava/io/File;
    //   87: astore 6
    //   89: aload 6
    //   91: ifnull -16 -> 75
    //   94: aload 6
    ...
    //   119: aconst_null
    //   120: astore_3
    //   121: new 210	java/io/BufferedInputStream
    //   124: astore_2
    //   125: new 212	java/io/FileInputStream
    //   128: astore 9
    //   130: aload 9
    //   132: aload 8
    //   134: invokespecial 213	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   137: aload_2
    //   138: aload 9
    //   140: invokespecial 216	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   143: aload_2
    //   144: invokestatic 222	com/a/a/a/c$a:a	(Ljava/io/InputStream;)Lcom/a/a/a/c$a;
    //   147: astore_3
    //   148: aload 8
    //   150: invokevirtual 225	java/io/File:length	()J
    //   153: lstore 10
    //   155: aload_3
    //   156: lload 10
    //   158: putfield 80	com/a/a/a/c$a:a	J
    //   161: aload_3
    //   162: getfield 285	com/a/a/a/c$a:b	Ljava/lang/String;
    //   165: astore 9
    //   167: aload_0
    //   168: aload 9
    //   170: aload_3
    //   171: invokespecial 288	com/a/a/a/c:a	(Ljava/lang/String;Lcom/a/a/a/c$a;)V
    //   174: aload_2
    //   175: invokevirtual 289	java/io/BufferedInputStream:close	()V
    //   178: iload 5
    //   180: iconst_1
    //   181: iadd
    //   182: istore_1
    ...
    //   196: ifnull +9 -> 205
    //   199: aload 8
    //   201: invokevirtual 134	java/io/File:delete	()Z
    //   204: pop
    //   205: aload_2
    //   206: ifnull -28 -> 178
    //   209: aload_2
    //   210: invokevirtual 289	java/io/BufferedInputStream:close	()V
    //   213: goto -35 -> 178
    //   216: astore_2
    //   217: goto -39 -> 178
    //   220: astore_2
    ...
    //   222: ifnull +7 -> 229
    //   225: aload_3
    //   226: invokevirtual 289	java/io/BufferedInputStream:close	()V
    //   229: aload_2
    //   230: athrow
    //   231: astore_2
    //   232: aload_0
  ...
  public final void a(String paramString, b.a parama)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!bool1)
        {
          ...
          if (bool1)
          {
            ...
            t.a((String)localObject2, (Object[])localObject4);
          }
          l1 = b;
          ...
          if (i != 0)
          {
            ...
            localObject4 = Long.valueOf(l1);
            localObject6[k] = localObject4;
            t.a((String)localObject1, (Object[])localObject6);
          }
        }
        ...
        try
        {
          ...
          localObject6 = new com/a/a/a/c$a;
          ((c.a)localObject6).<init>(paramString, parama);
          bool2 = ((c.a)localObject6).a((OutputStream)localObject1);
          if (bool2) {
            break label650;
          }
          ...
          localObject6[0] = str2;
          t.b((String)localObject1, (Object[])localObject6);
        ...
        t.b((String)localObject5, arrayOfObject);
        continue;
        localObject4 = a;
      }
      finally {}
      ...
      str1.close();
      a(paramString, (c.a)localObject6);
      continue;
      label678:
      i = k;
      continue;
