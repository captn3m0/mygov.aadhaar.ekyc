  ...
  implements vc
{
  ...
  public vf(vc paramvc)
  {
    ...
    b = paramvc;
    localObject = new com/google/android/gms/b/vb;
    Context localContext = paramvc.g();
    ((vb)localObject).<init>(localContext, this, this);
    c = ((vb)localObject);
    localObject = b.l();
    if (localObject != null) {
      ((vd)localObject).a(this);
    }
    localObject = b.b();
