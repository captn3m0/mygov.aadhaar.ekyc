  ...
  implements ej
{
  ...
  public static ej a(IBinder paramIBinder)
  {
    ...
    for (;;)
    {
      return (ej)localObject;
      localObject = paramIBinder.queryLocalInterface("com.google.android.gms.signin.internal.ISignInCallbacks");
      if (localObject != null)
      {
        boolean bool = localObject instanceof ej;
        if (bool)
        {
          localObject = (ej)localObject;
          continue;
        }
      }
      localObject = new com/google/android/gms/b/ej$a$a;
      ((ej.a.a)localObject).<init>(paramIBinder);
    }
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    case 3: 
      ...
      if (j != 0)
      {
        localObject1 = (a)a.CREATOR.createFromParcel(paramParcel1);
      ...
      for (localObject1 = (ee)ee.CREATOR.createFromParcel(paramParcel1);; localObject1 = null)
      {
        a((a)localObject2, (ee)localObject1);
    ...
    case 7: 
      ...
      {
        a((Status)localObject2, (GoogleSignInAccount)localObject1);
        paramParcel2.writeNoException();
        j = i;
        break;
        localObject2 = null;
    ...
    if (j != 0) {}
    for (localObject1 = (eq)eq.CREATOR.createFromParcel(paramParcel1);; localObject1 = null)
    {
      a((eq)localObject1);
      paramParcel2.writeNoException();
      j = i;
...
/* Location:              com/google/android/gms/b/ej$a.class
